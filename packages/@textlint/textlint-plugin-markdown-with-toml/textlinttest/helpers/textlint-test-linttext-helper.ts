...
// types
import type { TextlintTestErrorMessage, TextlintTestOptions } from '@tests/types/textlint-test.types';
 ...
 */
const parseExpectedJson = (jsonText: string): TextlintTestErrorMessage[] => {
...
const validateMessages = (
  actual: TextlintTestErrorMessage[],
  expected: TextlintTestErrorMessage[],
) => {
